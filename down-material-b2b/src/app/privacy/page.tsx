  ...
  return (
    <Container className="py-14 sm:py-20">
      <article className="prose-cn mx-auto max-w-3xl rounded-xl2 border border-slate-200 bg-white p-7 sm:p-10">
        ...
        <h2>1. 本站不提供公开询盘表单</h2>
        <p>
          本站不要求访客填写姓名、手机号、微信号、公司名称或采购需求，也不会将在线聊天内容或访客主动提供的联系方式写入本站内容数据库。原公开询盘写入接口已经停用。
        </p>
        ...
        <p>
          在平台名称和隐私信息未补齐前，运营方不应启用其脚本。本站不会把客服平台中的会话同步至内容数据库；如未来增加同步功能，应先更新本政策并履行适用的告知、同意和安全义务。
        </p>

        <h2>4. 必要访问日志与第三方基础设施</h2>
        <p>
          为交付网页、排查故障和防范攻击，网站托管或 CDN 服务商可能处理 IP
          地址、请求时间、访问路径、浏览器标识和安全事件等必要日志。本站内容数据库仅用于网站内容、后台设置、管理员数据及停用前可能形成的历史业务记录，不接收新的公开询盘或在线客服会话。
        </p>
        <p>
        ...
        <h2>5. 境外处理说明</h2>
        <p>
          本站已经通过停用公开询盘表单，避免由网站收集并传输访客姓名、手机号、微信号和采购留言。但托管、CDN、统计或客服服务是否构成个人信息境外提供，仍应根据正式部署地区、服务商实际数据流和法律要求逐项评估。
        </p>
        <p>
